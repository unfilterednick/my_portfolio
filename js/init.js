...
jQuery(document).ready(function(){
	...
	jQuery(window).load('body', function(){
		setTimeout(function(){
        jQuery('.sting_tm_preloader').addClass('loaded');
    }, 1000);
	});
...
function sting_tm_kenburn_slider(){
	
	"use strict";
	
		jQuery(function() {
			jQuery('.sting_tm_kenburn_hero .overlay_slider').vegas({
			timer:false,	
